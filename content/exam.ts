...
export const examObjectiveGroups: ExamObjectiveGroup[] = [
  ...
  { id: 'model-features', domainId: 'models', title: 'Configure model features', detail: 'Dynamic formats, field parameters, large models, and composite models.', experiences: [{ title: 'Field Parameter Explorer', state: 'built', href: '#/lab/field-parameters' }, { title: 'Composite Model Lab', state: 'planned' }] },
