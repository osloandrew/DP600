...
export const examObjectiveGroups: ExamObjectiveGroup[] = [
  { id: 'security', domainId: 'maintain', title: 'Security and access', detail: 'Workspace and item access, RLS, CLS, OLS, and file-level security.', experiences: [{ title: 'Security Lens', state: 'planned' }] },
  ...
  { id: 'transform', domainId: 'prepare', title: 'Transform data', detail: 'Views, procedures, derived data, joins, quality, types, and filters.', experiences: [{ title: 'Transformation Workbench', state: 'planned' }] },
  ...
  { id: 'query', domainId: 'prepare', title: 'Query and analyze', detail: 'Visual Query Editor, T-SQL, KQL, DAX, filtering, and aggregation.', experiences: [{ title: 'DAX Microscope', state: 'partial', href: '#/lab/dax' }, { title: 'Query Language Lab', state: 'planned' }] },
  { id: 'model-design', domainId: 'models', title: 'Design semantic models', detail: 'Storage modes, star schemas, relationships, bridge tables, and many-to-many.', experiences: [{ title: 'Relationship Lab', state: 'built', href: '#/lab/relationships' }, { title: 'Schema Lab', state: 'built', href: '#/lab/schema' }, { title: 'Storage Mode Lab', state: 'planned' }] },
  { id: 'dax', domainId: 'models', title: 'Create model calculations', detail: 'Variables, iterators, table filters, windowing, information functions, and calculation groups.', experiences: [{ title: 'DAX Microscope', state: 'partial', href: '#/lab/dax' }, { title: 'Calculation Group Lab', state: 'planned' }] },
  { id: 'model-features', domainId: 'models', title: 'Configure model features', detail: 'Dynamic formats, field parameters, large models, and composite models.', experiences: [{ title: 'Field Parameter Explorer', state: 'planned' }, { title: 'Composite Model Lab', state: 'planned' }] },
  { id: 'performance', domainId: 'models', title: 'Optimize performance', detail: 'Query, report visual, and DAX performance.', experiences: [{ title: 'Performance Lab', state: 'planned' }, { title: 'DAX Microscope', state: 'partial', href: '#/lab/dax' }] },
  ...
  { id: 'incremental', domainId: 'models', title: 'Configure incremental refresh', detail: 'Range parameters, policies, partitions, and refresh windows.', experiences: [{ title: 'Incremental Refresh Time Machine', state: 'planned' }] },
];
