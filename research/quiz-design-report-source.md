...
The round layout applies four additional findings. First, Microsoft uses persistent question-count and review affordances in its exam experience, so practice retains those cues without introducing a timer. Second, W3C cognitive-accessibility guidance recommends predictable placement, few primary choices, short critical paths, whitespace, and user-controlled detail. Third, cognitive-load research supports coherence, signaling, spatial contiguity, and segmentation: the scenario now precedes the decision, related text stays in one question card, secondary rationale is disclosed on request, and decorative UI has been removed. Fourth, W3C motion guidance supports eliminating nonessential animation. The result uses a stable sequence and reserved feedback area to minimize layout shifts. [Microsoft exam experience](https://learn.microsoft.com/en-us/credentials/support/exam-duration-exam-experience); [W3C: Avoid Too Much Content](https://www.w3.org/WAI/WCAG2/supplemental/patterns/o5p03-manageable-quantity/); [W3C: Predictable](https://www.w3.org/WAI/WCAG22/Understanding/predictable.html); [Five Strategies for Optimizing Instructional Materials](https://pmc.ncbi.nlm.nih.gov/articles/PMC7940870/); [W3C: Pause, Stop, Hide](https://www.w3.org/WAI/WCAG22/Understanding/pause-stop-hide.html)
