...
describe('Direct Lake engine', () => {
  ...
  it('keeps changed data outside the frame until refresh', () => {
    const changed = reduceDirectLake(initialDirectLakeState, {
      type: 'change-data',
    });
