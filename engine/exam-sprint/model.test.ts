...
describe('exam sprint plan', () => {
  ...
  it('adds retrieval only after a completed guided stop exists', () => {
    const plan = createSprintPlan(
      {
        ...emptyProgress,
        journeyProgress: {
          'from-question-to-report': {
            currentStopId: 'choose-store',
            completedStopIds: ['question-orientation'],
          },
        },
      },
      '2026-09-01',
    ...
    const plan = createSprintPlan(
      {
        ...
        journeyProgress: {
          'from-question-to-report': {
            currentStopId: firstJourneyStops.at(-1)!,
            completedStopIds: firstJourneyStops,
          },
        },
      },
      '2026-09-01',
